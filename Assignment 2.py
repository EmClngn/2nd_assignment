...
pyfiglet_colored_1 = pyfiglet.figlet_format("Welcome!",font="small", justify="center",width=110)
colors = ['bold yellow']
for color in colors:
    print(f'[{color}]{pyfiglet_colored_1}[/{color}]')
    
print(pyfiglet.figlet_format("Allow me to ask some questions", font="term", justify="center",width=110))
...
def if_else_no() :
    ...
    pyfiglet_colored_2 = pyfiglet.figlet_format("\n""So your name is: "+input_name+"", font="term", justify="center",width=110)
    pyfiglet_colored_3 = pyfiglet.figlet_format("\n""You are: "+input_age+"", font="term", justify="center",width=110)
    pyfiglet_colored_4 = pyfiglet.figlet_format("\n""And you live in: "+input_address+"", font="term", justify="center",width=110)
    for color in colors:
        print(f'[{color}]{pyfiglet_colored_2}[/{color}]')
        print(f'[{color}]{pyfiglet_colored_3}[/{color}]')
        print(f'[{color}]{pyfiglet_colored_4}[/{color}]')
    
    pyfiglet_colored_5 = pyfiglet.figlet_format("Thank you for answering", font="small", justify="center",width=115)
